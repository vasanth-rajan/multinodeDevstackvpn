...
vm2 = novaVmInst.createVmInstance("VPNaaSTestVm2", networkId2)
print vm2
...
vpnConn1 = router_Create.vpnIpsecSiteConnection("EastEndIpsecConn", westPeerIp, "[172.24.4.0/24]", vpnServiceId1, ikePolicyId, ipsecPolicyId)
vpnConn2 = router_Create.vpnIpsecSiteConnection("WestEndIpsecConn", eastPeerIp, "[172.24.4.0/24]", vpnServiceId2, ikePolicyId, ipsecPolicyId)
